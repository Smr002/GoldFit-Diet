        ...
        <Grid item xs={12} md={6}>
          <Paper 
            ...
            sx={{ 
              p: 2, 
              mb: 2,
              bgcolor: isDarkMode ? 'rgba(30, 30, 30, 0.7)' : 'rgba(246, 246, 246, 0.7)',
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            ...
            <List dense disablePadding>
              ...
              <Divider sx={{ my: 1, borderColor: isDarkMode ? 'rgba(255, 255, 255, 0.1)' : undefined }} />
        ...
        <Button
          ...
          sx={{
            ...
            '&:hover': {
              ...
              backgroundColor: isDarkMode ? 'rgba(255, 215, 0, 0.1)' : undefined,
            }
          }}
        >
          Back
