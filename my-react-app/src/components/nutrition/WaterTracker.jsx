        ...
        >
                  ...
                  >
                    ...
                    <Box
                      sx={{
                        ...
                        animation:
                          percentFilled > 0
                            ? "waterWave 2s ease-in-out infinite"
                            : "none",
                        "@keyframes waterWave": {
                    ...
                    >
                      <Button
                        ...
                        sx={{
                          ...
                          bgcolor:
                            waterToAdd === amount ? "#2196f3" : "transparent",
                          borderColor: "#2196f3",
          ...
          >
            <Typography variant="body2" color="text.secondary">
              ...
              />
              Hydration Tip: Try to drink water regularly throughout the day
              instead of large amounts at once.
            </Typography>
          </Box>
        </Paper>
      </Fade>
