...
const SleepTracker = ({ currentHours = 7, onLogSleep, selectedDay }) => {
  ...
  const getSleepQuality = (hours) => {
    ...
    if (hours >= 6 && hours < 7)
      return { text: "Borderline", color: themeColors.warning };
    if (hours >= 7 && hours <= 9)
      return { text: "Optimal", color: themeColors.primary };
  ...
  const getFormattedDate = () => {
    if (selectedDay && selectedDay.date) {
      try {
        ...
        return new Date(selectedDay.date).toLocaleDateString("en-US", {
          month: "short",
          day: "numeric",
        });
      } catch (error) {
      ...
      >
              ...
              <Zoom in={showContent} timeout={400}>
                <Box
                  ...
                  sx={{
                    ...
                    alignItems: "center",
                    justifyContent: "center",
                    background: `conic-gradient(${sleepQuality.color} ${
                      (sleepHours / 12) * 100
                    }%, ${themeColors.light} 0)`,
                    transition:
                      "background 0.5s ease, transform 0.3s ease, box-shadow 0.3s ease",
                    ...
                    "@keyframes rippleEffect": {
                      ...
                      "50%": {
                        boxShadow: `0 4px 25px rgba(0,0,0,0.15), 0 0 0 15px ${sleepQuality.color}40`,
                      },
                      "100%": {
                        boxShadow: `0 4px 20px rgba(0,0,0,0.1), 0 0 0 5px ${themeColors.light}30`,
                      },
        ...
        >
          <Typography variant="body2" color="text.secondary">
            ...
            />
            Sleep Tip: Maintain a consistent sleep schedule, even on weekends,
