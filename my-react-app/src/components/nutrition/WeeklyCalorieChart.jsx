          ...
          {days.map((day, index) => {
            ...
            return (
              ...
              >
                ...
                <Zoom in={isHighlighted || selectedDay === index} timeout={200}>
                  <Box
                    sx={{
                      position: "absolute",
                      top: -28,
                  ...
                  sx={{
                    ...
                    boxShadow:
                      day.isToday || selectedDay === index
                        ...
                        : "none",
                    "&::before":
                      calorieData[index] > calorieTarget
                        ? {
                            content: '""',
                            position: "absolute",
                            top: `${
                              (calorieTarget / calorieData[index]) * 100
                            }%`,
                            left: 0,
                            right: 0,
                            height: "2px",
                ...
                >
                  ...
                  {/* Selected indicator (if not today) */}
        ...
        >
          ...
          <Box>
            ...
            <Typography variant="body2" fontWeight="medium">
              {formatCalories(
                Math.round(calorieData.reduce((sum, curr) => sum + curr, 0) / 7)
              )}{" "}
              cal
            </Typography>
          </Box>
          ...
          <Box sx={{ textAlign: "right" }}>
            ...
            <Typography variant="body2" fontWeight="medium">
              {formatCalories(calorieData.reduce((sum, curr) => sum + curr, 0))}{" "}
              cal
            </Typography>
          </Box>
        </Box>
